...
def main():
    ...
    # Displacement params
    parser.add_argument("--lookback", type=int, default=20, help="Lookback bars for avg range")
    parser.add_argument("--displacement-mult", type=float, default=1.5, help="Displacement threshold multiplier")
    parser.add_argument("--target-rr", type=float, default=2.0, help="Target R:R multiple (0=EOD)")
