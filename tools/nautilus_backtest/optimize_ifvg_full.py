"""
IFVG Retest Strategy — Full-Period Optimizer (2010-2026).

Sweeps shadow_threshold, max_wait_bars, tp1_points, trail_points across 16 years
...
# Parameter grid — focus on the most impactful params
PARAM_GRID = {
    "shadow_threshold_pct": [20.0, 30.0, 40.0],
    "max_wait_bars": [20, 30, 40],
...
for i, params in enumerate(combos):
    ...
    sys.stdout.write(f"\r[{i+1}/{len(combos)}] st={params['shadow_threshold_pct']:.0f}% "
...
output_path = output_dir / "ifvg_full_sweep.csv"
...
print(f"{'='*130}")
print(f"TOP 20 CONFIGURATIONS — IFVG RETEST FULL PERIOD 2010-2026 (by Sharpe, min 200 trades, PF > 1.0)")
print(f"{'='*130}")
...
# Also show by PF
print(f"\n{'='*130}")
print(f"TOP 10 BY PROFIT FACTOR — IFVG RETEST FULL PERIOD 2010-2026")
print(f"{'='*130}")
