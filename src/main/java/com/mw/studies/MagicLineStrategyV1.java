...
@StudyHeader(
    ...
    name = "MAGIC_LINE_V1_HIGHER_R",
    label = "LBL_MAGIC_LINE_V1",
...
public class MagicLineStrategyV1 extends Study
{
    // ==================== Settings Keys ====================
    ...
    public void initialize(Defaults defaults)
    {
        ...
        grpStop.addRow(new IntegerDescriptor(CONTRACTS, "Contracts", 11, 1, 100, 1));  // V1: 11 contracts for unique identification
        ...
        grpExit.addRow(new DoubleDescriptor(TP1_R, "TP1 (R multiple)", 0.75, 0.25, 10.0, 0.25));
        grpExit.addRow(new DoubleDescriptor(TP2_R, "TP2 (R multiple)", 1.5, 0.5, 20.0, 0.25));
